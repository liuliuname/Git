...
/**
 * 面试题4: 现有的程序代码模拟产生了16个日志对象，并且需要运行16秒才能打印完这些日志，
 * 请在程序中增加4个线程去调用parseLog()方法来分头打印这16个日志对象，程序只需要运行4秒即可打印完这些日志对象。
 *
 *
 * 使用线程队列  ArrayBlockingQueue  方法 put放入时候会根据数据长度查看是否放慢 如果放慢会唤醒消费者进行take  take同理
 */
public class InterviewQuestionExaple3 {
